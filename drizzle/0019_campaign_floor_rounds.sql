CREATE TABLE IF NOT EXISTS "campaign_floor_rounds" (
  ...
  "audience_pulse_enabled" boolean DEFAULT false NOT NULL,
...
CREATE INDEX IF NOT EXISTS "idx_campaign_floor_audience_pulses_submission" ON "campaign_floor_audience_pulses" USING btree ("submission_id");
