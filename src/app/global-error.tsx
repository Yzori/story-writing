...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ backgroundColor: "var(--t-void)", color: "var(--t-text)", fontFamily: "system-ui, sans-serif", margin: 0 }}>
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "1.5rem" }}>
          ...
          <h1 style={{ fontSize: "1.75rem", fontWeight: 600, color: "var(--t-paper)", marginBottom: 8 }}>
            Something went wrong
          </h1>
          <p style={{ fontSize: 14, color: "var(--t-text-secondary)", maxWidth: 400, lineHeight: 1.6, marginBottom: 24 }}>
            An unexpected error occurred. Your work should be safe — try refreshing the page.
          </p>
          <button
            onClick={reset}
            style={{ background: "var(--t-gold)", color: "var(--t-void)", fontWeight: 600, padding: "10px 24px", borderRadius: 8, border: "none", cursor: "pointer", fontSize: 13 }}
          >
            Try again
          </button>
          {error.digest && (
            <p style={{ fontSize: 11, color: "var(--t-text-ghost)", marginTop: 16 }}>
