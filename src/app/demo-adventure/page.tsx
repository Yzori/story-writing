...
const MOCK_CHARACTERS: PlayerCharacter[] = [
  {
    ...
    stats: JSON.stringify({
      hp: { current: 24, max: 30 }, mp: { current: 12, max: 12 },
      attributes: { STR: 12, DEX: 18, CON: 14, INT: 16, WIS: 10, CHA: 8 },
      items: ["The Obsidian Shard (warm to touch)", "4x Vials of healing ash", "Map of the lower wards"],
    }),
    status: "active",
  ...
  },
  {
    ...
    stats: JSON.stringify({
      hp: { current: 18, max: 22 }, mp: { current: 8, max: 10 },
      attributes: { STR: 16, DEX: 14, CON: 12, INT: 10, WIS: 14, CHA: 12 },
      items: ["Silver longsword", "Cloak of minor warding"],
    }),
    status: "active",
  ...
  },
  {
    ...
    stats: JSON.stringify({
      hp: { current: 16, max: 20 }, mp: { current: 15, max: 18 },
      attributes: { STR: 8, DEX: 12, CON: 10, INT: 14, WIS: 18, CHA: 16 },
      items: ["Spirit lantern", "Pouch of grave-herbs", "Bone flute"],
    }),
    status: "active",
