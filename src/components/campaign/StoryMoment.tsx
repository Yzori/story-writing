...
const MOOD_PRESETS: Record<string, MoodPreset> = {
  ...
  revelation: {
    ...
    atmosphere: "bloom",
    vignette: 60,
    textClass: "font-display text-white",
    subtextClass: "font-serif text-white/50",
    textEffect: "bloom-reveal",
  },
  loss: {
    bg: "radial-gradient(ellipse at 50% 50%, rgba(40, 60, 100, 0.1) 0%, rgba(5, 5, 15, 0.98) 70%)",
    vignette: 90,
    textClass: "font-reading italic text-white/60",
    subtextClass: "font-serif text-white/30",
    textEffect: "standard",
    contentDrift: true,
  },
  ominous: {
  ...
  tense: {
    ...
    vignette: 100,
    textClass: "font-display text-white/90",
  ...
  calm: {
    ...
    vignette: 60,
    textClass: "font-serif italic text-white/80",
    subtextClass: "font-serif text-white/40",
    textEffect: "standard",
